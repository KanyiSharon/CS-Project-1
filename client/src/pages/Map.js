  ...
  useEffect(() => {
    const fetchStages = async () => {
      try {
        ...
        // Fallback stages data
        setStages([
          { stage_id: 1, name: 'Kencom Stage', latitude: -1.2871, longitude: 36.8225 },
          { stage_id: 2, name: 'Railway Station', latitude: -1.2833, longitude: 36.8261 },
          { stage_id: 3, name: 'Globe Cinema', latitude: -1.2844, longitude: 36.8172 },
          { stage_id: 4, name: 'Afya Centre', latitude: -1.2884, longitude: 36.8197 },
          { stage_id: 5, name: 'Nation Centre', latitude: -1.2903, longitude: 36.8210 }
        ]);
      }
    };
    fetchStages();
    ...
    const fetchOperations = async () => {
      try {
        ...
        setOperations([
          {
            sacco_id: 1,
            sacco_name: 'Kenya Bus Service',
            base_fare_range: 'KES 30-50',
            route_name: 'CBD - Westlands',
            from_stage: 'Kencom Stage',
            stage_latitude: -1.2871,
            stage_longitude: 36.8225
          },
          {
            sacco_id: 2,
            sacco_name: 'City Hoppa',
            base_fare_range: 'KES 20-40',
            route_name: 'CBD - Eastlands',
            from_stage: 'Railway Station',
            stage_latitude: -1.2833,
            stage_longitude: 36.8261
          }
        ]);
      }
    };
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .green-marker {
        ...
        width: 25px;
        height: 41px;
        background-image: url('data:image/png;base64,');
